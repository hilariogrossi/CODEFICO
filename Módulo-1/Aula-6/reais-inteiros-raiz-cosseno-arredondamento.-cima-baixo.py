...
# solicita ao usuário que entre com um valor do tipo escolhido. No caso de ter escolhido trabalhar com número inteiro o programa deve informar a
# raiz quadrada do número e também o seu cosseno. No caso de ter escolhido trabalhar com número real o programa deve usar as funções de arredondamente
# para imprimir os valores arrendondados para cima e para baixo.
