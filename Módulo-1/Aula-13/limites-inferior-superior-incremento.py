...
para implementar as repetições. Caso o valor do incremento seja negativo a sequência deve ser
...
if incremento > 0:
    print('\nValores do Intervalo: ', end='')

    for i in range(menor, maior + 1, incremento):
      print(f'{i}', end=' ')
    ...
    for i in range(maior, menor - 1, incremento):
      print(f'{i}', end=' ')
